...
public class asecActivity
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        try {
            localSQLiteDatabase.execSQL("CREATE TABLE asec(id INTEGER);");
            localSQLiteDatabase.beginTransaction();
            SQLiteStatement localSQLiteStatement = localSQLiteDatabase.compileStatement("INSERT INTO asec VALUES(?);");
            Integer localInteger5 = Integer.valueOf(1);
            for (Integer localInteger6 = Integer.valueOf(1); localInteger5.intValue() <= 60; localInteger6 = Integer.valueOf(1 + localInteger6.intValue())) {
        ...
        localCursor1 = localSQLiteDatabase.rawQuery("SELECT * FROM asec;", null);
        ...
        local1 = new View.OnClickListener() {
            public void onClick(View paramAnonymousView) {
                ...
                for (Integer localInteger2 = Integer.valueOf(1); localInteger1.intValue() <= 60; localInteger2 = Integer.valueOf(1 + localInteger2.intValue())) {
