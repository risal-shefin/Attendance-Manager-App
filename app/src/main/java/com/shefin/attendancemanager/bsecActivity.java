...
public class bsecActivity
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        try {
            localSQLiteDatabase.execSQL("CREATE TABLE bsec(id INTEGER);");
            localSQLiteDatabase.beginTransaction();
            SQLiteStatement localSQLiteStatement = localSQLiteDatabase.compileStatement("INSERT INTO bsec VALUES(?);");
            Integer localInteger5 = Integer.valueOf(61);
            for (Integer localInteger6 = Integer.valueOf(1); localInteger5.intValue() <= 120; localInteger6 = Integer.valueOf(1 + localInteger6.intValue())) {
        ...
        localCursor1 = localSQLiteDatabase.rawQuery("SELECT * FROM bsec;", null);
        ...
        if (localCursor2.moveToFirst()) {
            do {
                int i = -60 + localCursor2.getInt(0);
