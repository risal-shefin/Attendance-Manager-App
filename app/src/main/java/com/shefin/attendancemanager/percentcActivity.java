...
public class percentcActivity
    ...
    public void outputToFile(String fileName, String pdfContent, String encoding) {
        ...
        try {
            ...
            try {
                ...
                pdfFile.close();
                Toast.makeText(percentcActivity.this, "Result exported in Internal Storage", Toast.LENGTH_LONG).show();
            } catch (FileNotFoundException e) {
                Toast.makeText(percentcActivity.this, "File I/O Error !", Toast.LENGTH_LONG).show();
            }
        } catch (IOException e) {
            Toast.makeText(percentcActivity.this, "File I/O Error !", Toast.LENGTH_LONG).show();
        }
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        setContentView(R.layout.percentc);
        ...
        rey = 740;
        writer.addText(rex - 2, rey, 20, "Roll");
        writer.addText(rex + 220, rey, 20, "Percentage");
        rey -= 40;

        Integer counter = 121;
        Double localDouble = Double.valueOf(14.0D * i);
        Cursor localCursor1 = localSQLiteDatabase.rawQuery("SELECT roll, total  FROM " + str2 + " WHERE year = " + percenttypeActivity.year + " AND section = 'C'", null);
        if (localCursor1.moveToFirst()) {
            do {
                Integer localInteger3 = Integer.valueOf(-120 + localCursor1.getInt(0));
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(percentcActivity.this);
