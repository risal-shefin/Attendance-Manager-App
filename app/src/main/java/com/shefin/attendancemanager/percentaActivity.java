...
public class percentaActivity
    ...
    public void outputToFile(String fileName, String pdfContent, String encoding) {
        ...
        try {
            ...
            try {
                ...
                pdfFile.close();
                Toast.makeText(percentaActivity.this, "Result exported in Internal Storage", Toast.LENGTH_LONG).show();
            } catch (FileNotFoundException e) {
                Toast.makeText(percentaActivity.this, "File I/O Error !", Toast.LENGTH_LONG).show();
            }
        } catch (IOException e) {
            Toast.makeText(percentaActivity.this, "File I/O Error !", Toast.LENGTH_LONG).show();
        }
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        setContentView(R.layout.percenta);
        TextView[] arrayOfTextView = new TextView[65];
        for (Integer localInteger1 = Integer.valueOf(1); localInteger1.intValue() <= 60; localInteger1 = Integer.valueOf(1 + localInteger1.intValue())) {
            String str4 = "percent" + localInteger1.toString();
            int k = getResources().getIdentifier(str4, "id", getPackageName());
            arrayOfTextView[localInteger1.intValue()] = ((TextView) findViewById(k));
        }
        int i = 1;
        ...
        Cursor localCursor1 = localSQLiteDatabase.rawQuery("SELECT roll, total  FROM " + str2 + " WHERE year = " + percenttypeActivity.year + " AND section = 'A'", null);
        if (localCursor1.moveToFirst()) {
            do {
                Integer localInteger2 = Integer.valueOf(localCursor1.getInt(0));
                ...
                arrayOfTextView[localInteger2.intValue()].setText(str3);
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(percentaActivity.this);
